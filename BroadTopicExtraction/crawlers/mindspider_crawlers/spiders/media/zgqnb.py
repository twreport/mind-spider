...
class ZgqnbSpider(MediaSpider):
    ...
    platform = "zgqnb"
    media_type = "central"
    allowed_domains = ["cyol.com", "zqb.cyol.com"]
    ...
    def start_requests(self) -> Generator:
        """生成起始请求"""
        base_url = f"https://zqb.cyol.com/html/{self.year}-{self.month}/{self.day}/"
        url = f"{base_url}nbs.D110000zgqnb_01.htm"
    ...
    def parse_index(self, response: Response) -> Generator:
        ...
        for a in page_links:
            ...
            if href:
                item_url = response.meta["base_url"] + href + "?t=3"
                yield scrapy.Request(
                    item_url,
                    meta={
    ...
    def parse(self, response: Response) -> Generator:
        ...
        # 移除 URL
        news_text = self._remove_urls(news_text)
